...
func truncateAll(t *testing.T) {
	...
	_, err := testPool.Exec(context.Background(),
		`TRUNCATE playtest, code, applicant, audit_log, leader_lease, nda_acceptance, survey, survey_response, adt_linkage, adt_link_pending, announcement, announcement_recipient RESTART IDENTITY CASCADE`)
	if err != nil {
